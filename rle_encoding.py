# -*- coding: utf-8 -*-
"""
Created on Tue Apr  3 16:23:30 2018
...
if __name__ == '__main__':
    ...
    outfile = open("output_new.csv",'w')
    outfile.write("ImageId,EncodedPixels")


    for d in dirs:
        input_dir = input_path + d
        masks = [f for f in os.listdir(input_dir) if f.endswith('_mask.png')]
        ...
        for i,m in enumerate(masks[:]):
            ...
            img = Image.open(os.path.join(input_dir, m))
